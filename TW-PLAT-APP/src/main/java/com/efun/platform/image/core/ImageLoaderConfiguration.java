 ...
 *******************************************************************************/
package com.efun.platform.image.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import com.efun.platform.image.cache.disc.DiskCache;
import com.efun.platform.image.cache.disc.naming.FileNameGenerator;
import com.efun.platform.image.cache.memory.MemoryCache;
import com.efun.platform.image.cache.memory.impl.FuzzyKeyMemoryCache;
import com.efun.platform.image.core.assist.FlushedInputStream;
import com.efun.platform.image.core.assist.ImageSize;
import com.efun.platform.image.core.assist.QueueProcessingType;
import com.efun.platform.image.core.decode.ImageDecoder;
import com.efun.platform.image.core.download.ImageDownloader;
import com.efun.platform.image.core.process.BitmapProcessor;
import com.efun.platform.image.utils.L;
import com.efun.platform.image.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.efun.platform.image.cache.disc.impl.UnlimitedDiscCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.efun.platform.image.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.efun.platform.image.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.efun.platform.image.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.efun.platform.image.cache.disc.impl.ext.LruDiscCache LruDiscCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.efun.platform.image.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.efun.platform.image.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.efun.platform.image.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.efun.platform.image.cache.disc.impl.UnlimitedDiscCache
		 * BaseDiscCache}. Cache directory is defined by
		 * {@link com.efun.platform.image.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.efun.platform.image.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.efun.platform.image.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.efun.platform.image.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.efun.platform.image.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
