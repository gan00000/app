...
import com.efun.platform.module.base.BaseActivity.ActivityStatusObserver;
import com.efun.platform.module.base.FixedActivity.AsyncEntry;
 ...
 * 
 */
public abstract class FixedFragment extends BaseFragment implements OnRequestListener {
...
//		if(hasShare){			
//			ShareUtils.shareGoogleJiaOnActivityResult(getActivity(), requestCode, resultCode, data);
//		}
//	}
