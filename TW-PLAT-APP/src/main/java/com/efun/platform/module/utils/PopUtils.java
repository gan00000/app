								...
								public void onClick(View v) {
									//twitter分享
										...
										case BeanType.BEAN_SETTINGBEAN:
											...
											break;
										case BeanType.BEAN_GAMENEWSBEAN:
											ShareUtils.shareTwitterWithWord(context, context.getString(E_string.efun_pd_share_summary_content)+" : "+((GameNewsBean)mBean).getIphoneUrl());
											break;
										}										
										pop.dismiss();
								}
							...
							itemFive.setOnClickListener(new OnClickListener() {
								...
								public void onClick(View v) {
									...
									case BeanType.BEAN_SETTINGBEAN:
										...
										break;
									case BeanType.BEAN_GAMENEWSBEAN:
										ShareUtils.shareEmail(context, context.getString(E_string.efun_pd_share_summary_content), ((GameNewsBean)mBean).getTitle()+" : "+((GameNewsBean)mBean).getIphoneUrl());
										break;
									}
									pop.dismiss();
								}
