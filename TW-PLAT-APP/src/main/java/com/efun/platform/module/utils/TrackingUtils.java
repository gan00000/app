...
//	public static final String ACTION_BANNER="Banner";//Banner//去掉，改为Information
	...
	public static final String NAME_MYSELF_SYS_INFO = "System_Info_Center";//信件中心
		...
		public static final String NAME_MYSELF_SING = "Sign_Button";//签到按钮
		public static final String NAME_MYSELF_SING_GIFT = "SignInGift";//签到礼包，后面拼接天数
	...
	public static final String NAME_ACCOUNT_LOGIN_FACEBOOK ="Login_Facebook";//FB登录
		public static final String NAME_ACCOUNT_UPDATE_PHONE_DIAL ="Update_Phone_Dial";//拨打号码更新手机号码
		public static final String NAME_ACCOUNT_UPDATE_PHONE_CODE ="Update_Phone_Code";//验证码更新手机号码
		public static final String NAME_ACCOUNT_BIND_PHONE_DIAL ="Bind_Phone_Dial";//拨打号码绑定手机
		public static final String NAME_ACCOUNT_BIND_PHONE_CODE ="Bind_Phone_Code";//验证码绑定手机
