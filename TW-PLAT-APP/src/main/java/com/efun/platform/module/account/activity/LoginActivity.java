...
//		.startSignIn(onLoginListener)
	...
	private ImageView mFacebookLayout, mGoogleLayout, mBahamutLayout;
...
//				mRegisterPhone.postInvalidate();
//				// 切换后将EditText光标置于末尾
//				CharSequence charSequence = mRegisterPhone.getText();
//				if (charSequence instanceof Spannable) {
//					Spannable spanText = (Spannable) charSequence;
//					Selection.setSelection(spanText, charSequence.length());
//				}
...
//		requestWithoutDialog(createPhoneAreaRequest());
	}
...
//	private BaseRequestBean[] createPhoneAreaRequest(){
	...
	private CountDownTimer settingCountTime(final TextView controlBtn ,boolean firstFlag){
		...
		downTime = new CountDownTimer(currentTime,1000) {
			...
			public void onTick(long millisUntilFinished) {
				// TODO Auto-generated method stub
				EfunDatabase.saveSimpleInfo(LoginActivity.this, IPlatDatabaseValues.PLATFORM_FILE, IPlatDatabaseValues.DATA_REMAIN_TIME, millisUntilFinished);
				controlBtn.setBackgroundResource(E_drawable.efun_pd_a6a6a6_rectangle_bg);
				controlBtn.setText(millisUntilFinished/1000+EfunResourceUtil.findStringByName(LoginActivity.this, "efun_pd_get_vcode_again_timedown"));
			}
			
			@Override
			public void onFinish() {
				// TODO Auto-generated method stub
				EfunDatabase.saveSimpleInfo(LoginActivity.this, IPlatDatabaseValues.PLATFORM_FILE, IPlatDatabaseValues.DATA_REMAIN_TIME, 0);
				controlBtn.setBackgroundResource(E_drawable.efun_pd_2eade4_rectangle_bg);
				controlBtn.setText(EfunResourceUtil.findStringByName(LoginActivity.this, "efun_pd_get_vcode_again"));
				if(vcodePhone != null){
					vcodePhone = null;
				}
