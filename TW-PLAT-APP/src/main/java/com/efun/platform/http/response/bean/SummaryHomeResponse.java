...
public class SummaryHomeResponse extends BaseResponseBean{
	...
	public void setValues(Object object) {
		...
		for (int i = 0; i < newsArray.length(); i++) {
			...
			summary.setId(jsonObject.optLong("id"));
			summary.setSubTitle(jsonObject.optString("subTitle"));
			summary.setVideoPic(jsonObject.optString("videoPic"));
			summary.setVideoUrl(jsonObject.optString("videoUrl"));
			summary.setVideoTime(jsonObject.optString("videoTime"));
			summary.setLikes(jsonObject.optInt("likes"));
			summary.setIsLiked(jsonObject.optInt("isLiked"));
