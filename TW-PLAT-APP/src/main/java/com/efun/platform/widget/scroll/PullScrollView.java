...
//        mHeaderVisibleHeight = getResources().getDimension(R.id.)
    }
    

	public void setHeaderVisibleHeight(int mHeaderVisibleHeight) {
		this.mHeaderVisibleHeight = mHeaderVisibleHeight;
	}
