...
class AuthorizationClient implements Serializable {
    ...
    boolean checkInternetPermission() {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            String errorType = ResHelper.findStringByName(context, "com_facebook_internet_permission_error_title");
            String errorDescription = ResHelper.findStringByName(context, "com_facebook_internet_permission_error_message");
