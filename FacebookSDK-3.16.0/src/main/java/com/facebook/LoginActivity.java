...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ResHelper.findLayoutIdByName(this,"com_facebook_login_activity_layout"));
        ResHelper.setContext(getApplicationContext());
        ...
        authorizationClient.setBackgroundProcessingListener(new AuthorizationClient.BackgroundProcessingListener() {
            ...
            public void onBackgroundProcessingStarted() {
                findViewById(ResHelper.findViewIdByName(getApplicationContext(), "com_facebook_login_activity_progress_bar")).setVisibility(View.VISIBLE);
            }

            @Override
            public void onBackgroundProcessingStopped() {
                findViewById(ResHelper.findViewIdByName(getApplicationContext(), "com_facebook_login_activity_progress_bar")).setVisibility(View.GONE);
            }
        });
    }
