...
public class UserSettingsFragment extends FacebookFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(ResHelper.findLayoutIdByName(getActivity(), "com_facebook_usersettingsfragment"), container, false);
        loginButton = (LoginButton) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_usersettingsfragment_login_button"));
        ...
        connectedStateLabel = (TextView) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_usersettingsfragment_profile_name"));
        
        // if no background is set for some reason, then default to Facebook blue
        if (view.getBackground() == null) {
            view.setBackgroundColor(getResources().getColor(ResHelper.findColorIdByName(getActivity(), "com_facebook_blue")));
        } else {
    ...
    private void updateUI() {
        ...
        if (isSessionOpen()) {
            connectedStateLabel.setTextColor(getResources().getColor(ResHelper.findColorIdByName(getActivity(), "com_facebook_usersettingsfragment_connected_text_color")));
            connectedStateLabel.setShadowLayer(1f, 0f, -1f,
                    getResources().getColor(ResHelper.findColorIdByName(getActivity(), "com_facebook_usersettingsfragment_connected_shadow_color")));
            ...
            if (user != null) {
                ...
                connectedStateLabel.setText(getResources().getString(
                        ResHelper.findStringIdByName(getActivity(), "com_facebook_usersettingsfragment_logged_in")));
                Drawable noProfilePic = getResources().getDrawable(ResHelper.findDrawableIdByName(getActivity(), "com_facebook_profile_default_icon"));
                noProfilePic.setBounds(0, 0,
                        getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getActivity(), "com_facebook_usersettingsfragment_profile_picture_width")),
                        getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getActivity(), "com_facebook_usersettingsfragment_profile_picture_height")));
                connectedStateLabel.setCompoundDrawables(null, noProfilePic, null, null);
            }
        } else {
            int textColor = getResources().getColor(ResHelper.findColorIdByName(getActivity(), "com_facebook_usersettingsfragment_not_connected_text_color"));
            connectedStateLabel.setTextColor(textColor);
            connectedStateLabel.setShadowLayer(0f, 0f, 0f, textColor);
            connectedStateLabel.setText(ResHelper.findStringByName(getActivity(), "com_facebook_usersettingsfragment_not_logged_in"));
