...
//        a.recycle();
    ...
    private void setBlankProfilePicture() {
        if (customizedDefaultProfilePicture == null) {
          int blankImageResource = isCropped() ?
                  ResHelper.findDrawableIdByName(getContext(), "com_facebook_profile_picture_blank_square") :
                  ResHelper.findDrawableIdByName(getContext(), "com_facebook_profile_picture_blank_portrait");
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (presetSizeType) {
            case SMALL:
                dimensionId = ResHelper.findDimenIdByName(getContext(), "com_facebook_profilepictureview_preset_size_small");
                break;
            case NORMAL:
                dimensionId = ResHelper.findDimenIdByName(getContext(), "com_facebook_profilepictureview_preset_size_normal");
                break;
            case LARGE:
                dimensionId = ResHelper.findDimenIdByName(getContext(), "com_facebook_profilepictureview_preset_size_large");
                break;
            case CUSTOM:
                if (!forcePreset) {
