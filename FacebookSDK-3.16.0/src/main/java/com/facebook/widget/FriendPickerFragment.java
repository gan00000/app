...
public class FriendPickerFragment extends PickerFragment<GraphUser> {
    ...
    public FriendPickerFragment(Bundle args) {
        super(GraphUser.class, "com_facebook_friendpickerfragment", args);
    ...
    PickerFragmentAdapter<GraphUser> createAdapter() {
        PickerFragmentAdapter<GraphUser> adapter = new PickerFragmentAdapter<GraphUser>(
            ...
            protected int getGraphObjectRowLayoutId(GraphUser graphObject) {
                return ResHelper.findLayoutIdByName(getActivity(), "com_facebook_picker_list_row");
            }

            @Override
            protected int getDefaultPicture() {
                return ResHelper.findDrawableIdByName(getActivity(), "com_facebook_profile_default_icon");
            }
    ...
    String getDefaultTitleText() {
        return ResHelper.findStringByName(getActivity(), "com_facebook_choose_friends");
    }
