...
public abstract class PickerFragment<T extends GraphObject> extends Fragment {
    ...
    PickerFragment(Class<T> graphObjectClass, String layoutName, Bundle args) {
    	this.graphObjectClass = graphObjectClass;
    	this.layout = ResHelper.findLayoutIdByName(getActivity(), layoutName);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView = (ListView) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_picker_list_view"));
        ...
        activityCircle = (ProgressBar) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_picker_activity_circle"));
    ...
    String getDefaultDoneButtonText() {
        return ResHelper.findStringByName(getActivity(), "com_facebook_picker_done_button_text");
    }
    ...
    private void inflateTitleBar(ViewGroup view) {
        ViewStub stub = (ViewStub) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_picker_title_bar_stub"));
        if (stub != null) {
            ...
            final RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
                    ...
                    RelativeLayout.LayoutParams.MATCH_PARENT);
            layoutParams.addRule(RelativeLayout.BELOW, ResHelper.findViewIdByName(getActivity(), "com_facebook_picker_title_bar"));
            ...
            doneButton = (Button) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_picker_done_button"));
            if (doneButton != null) {
            ...
            titleTextView = (TextView) view.findViewById(ResHelper.findViewIdByName(getActivity(), "com_facebook_picker_title"));
            if (titleTextView != null) {
