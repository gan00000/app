...
public class WebDialog extends Dialog {
    ...
    public static final int DEFAULT_THEME = android.os.Build.VERSION.SDK_INT >= 14 ? android.R.style.Theme_DeviceDefault : android.R.style.Theme_Translucent_NoTitleBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setMessage(ResHelper.findStringByName(getContext(), "com_facebook_loading"));
    ...
    private void createCrossImage() {
        ...
        Drawable crossDrawable = getContext().getResources().getDrawable(ResHelper.findDrawableIdByName(getContext(), "com_facebook_close"));
