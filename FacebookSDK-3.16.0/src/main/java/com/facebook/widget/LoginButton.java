...
import com.facebook.*;
import com.facebook.efun.R;
import com.facebook.efun.ResHelper;
...
public class LoginButton extends Button {
    ...
    public LoginButton(Context context, AttributeSet attrs) {
        ...
        if (attrs.getStyleAttribute() == 0) {
            ...
            this.setTextColor(getResources().getColor(ResHelper.findColorIdByName(getContext(), "com_facebook_loginview_text_color")));
            this.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    getResources().getDimension(ResHelper.findDimenIdByName(getContext(), "com_facebook_loginview_text_size")));
            this.setTypeface(Typeface.DEFAULT_BOLD);
            if (isInEditMode()) {
                // cannot use a drawable in edit mode, so setting the background color instead
                // of a background resource.
                this.setBackgroundColor(getResources().getColor(ResHelper.findColorIdByName(getContext(), "com_facebook_blue")));
                // hardcoding in edit mode as getResources().getString() doesn't seem to work in IntelliJ
                loginText = "Log in with Facebook";
            } else {
                this.setBackgroundResource(ResHelper.findDrawableIdByName(getContext(), "com_facebook_button_blue"));
                this.setCompoundDrawablesWithIntrinsicBounds(ResHelper.findDrawableIdByName(getContext(), "com_facebook_inverse_icon"), 0, 0, 0);
                this.setCompoundDrawablePadding(
                        getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getContext(), "com_facebook_loginview_compound_drawable_padding")));
                this.setPadding(getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getContext(), "com_facebook_loginview_padding_left")),
                        getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getContext(), "com_facebook_loginview_padding_top")),
                        getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getContext(), "com_facebook_loginview_padding_right")),
                        getResources().getDimensionPixelSize(ResHelper.findDimenIdByName(getContext(), "com_facebook_loginview_padding_bottom")));
            }
        }
    ...
    private void checkNuxSettings() {
        if (nuxMode == ToolTipMode.DISPLAY_ALWAYS) {
            String nuxString = ResHelper.findStringByName(getContext(), "com_facebook_tooltip_default");
            displayNux(nuxString);
        } else {
    ...
    private void setButtonText() {
        if (sessionTracker != null && sessionTracker.getOpenSession() != null) {
            setText((logoutText != null) ? logoutText :
                    getResources().getString(ResHelper.findStringIdByName(getContext(), "com_facebook_loginview_log_out_button")));
        } else {
            setText((loginText != null) ? loginText :
                    getResources().getString(ResHelper.findStringIdByName(getContext(), "com_facebook_loginview_log_in_button")));
        }
    }
        ...
        public void onClick(View v) {
            ...
            if (openSession != null) {
                ...
                if (confirmLogout) {
                    ...
                    String logout = getResources().getString(ResHelper.findStringIdByName(getContext(), "com_facebook_loginview_log_out_action"));
                    String cancel = getResources().getString(ResHelper.findStringIdByName(getContext(), "com_facebook_loginview_cancel_action"));
                    String message;
                    if (user != null && user.getName() != null) {
                        message = String.format(getResources().getString(ResHelper.findStringIdByName(getContext(), "com_facebook_loginview_logged_in_as")), user.getName());
                    } else {
                        message = getResources().getString(ResHelper.findStringIdByName(getContext(), "com_facebook_loginview_logged_in_using_facebook"));
                    }
