...
public class ToolTipPopup {
    ...
    public void show() {
        if (mAnchorViewRef.get() != null) {
            ...
            TextView body = (TextView) mPopupContent.findViewById(
                    ResHelper.findViewIdByName(mContext, "com_facebook_tooltip_bubble_view_text_body"));
            body.setText(mText);
            if (mStyle == Style.BLUE) {
                mPopupContent.bodyFrame.setBackgroundResource(
                        ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_blue_background"));
                mPopupContent.bottomArrow.setImageResource(
                        ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_blue_bottomnub"));
                mPopupContent.topArrow.setImageResource(
                        ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_blue_topnub"));
                mPopupContent.xOut.setImageResource(ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_blue_xout"));
            } else {
                mPopupContent.bodyFrame.setBackgroundResource(
                        ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_black_background"));
                mPopupContent.bottomArrow.setImageResource(
                        ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_black_bottomnub"));
                mPopupContent.topArrow.setImageResource(
                        ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_black_topnub"));
                mPopupContent.xOut.setImageResource(ResHelper.findDrawableIdByName(mContext, "com_facebook_tooltip_black_xout"));
            }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            ...
            inflater.inflate(ResHelper.findLayoutIdByName(mContext, "com_facebook_tooltip_bubble"), this);
            topArrow = (ImageView) findViewById(ResHelper.findViewIdByName(mContext, "com_facebook_tooltip_bubble_view_top_pointer"));
            bottomArrow = (ImageView) findViewById(
                    ResHelper.findViewIdByName(mContext, "com_facebook_tooltip_bubble_view_bottom_pointer"));
            bodyFrame = findViewById(ResHelper.findViewIdByName(mContext,"com_facebook_body_frame"));
            xOut = (ImageView) findViewById(ResHelper.findViewIdByName(mContext, "com_facebook_button_xout"));
        }
