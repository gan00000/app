...
//		checkAPPVersionReq(getApplicationContext());
...
//						EfunLogUtil.enableDebug(true);
				...
				}else if(requestType==IPlatformRequest.REQ_ACCOUNT_LOGIN || requestType==IPlatformRequest.REQ_ACCOUNT_THIRD_LOGIN){
					//获取前一次登录时间，和当前登录时间
...
//						UserUtils.logout(getApplicationContext());
	...
	private BaseRequestBean[] needRequestBean(){
		...
		if(UserUtils.isLogin()){
			BaseRequestBean loginRequest = UserUtils.createRequest(getApplicationContext());
...
//	public void checkAPPVersionReq(final Context context){
//		Log.e("yang", "=======checkAPPVersionReq======");
//		EfunSwitchCmd efunSwitchCmd = new EfunSwitchCmd(context, "app");
//		efunSwitchCmd.setAppPlatform(HttpParam.PLATFORM_APP_PLATFORM);
//		efunSwitchCmd.setLanguage(HttpParam.LANGUAGE);
//		efunSwitchCmd.setGameCode("twjxqy");
//		//, HttpParam.LANGUAGE, "twjxqy", HttpParam.PLATFORM_APP_PLATFORM, AppUtils.getAppVersionName(context)
//		efunSwitchCmd.setPreferredUrl("https://luatest.efun.com");
//		efunSwitchCmd.setSparedUrl("https://luatest.efun.com");
//		
//		efunSwitchCmd.setCallback(new EfunCommandCallBack() {
//			
//			@Override
//			public void cmdCallBack(EfunCommand paramEfunCommand) {
//				Log.e("yang", "=======checkAPPVersionReq===cmdCallBack===");
//				String response = paramEfunCommand.getResponse();
//				Log.i("efun Switch", "response: " + response);
//				SwitchParameters switchParameters = EfunSwitchHelper.StrToSwitchParameters(response);
//				if (switchParameters == null) {
//					Log.e("efun Switch", "response data error" );
//					return;
//				}
//				
//				SwitchCheckversoinBean bean = new SwitchCheckversoinBean(switchParameters.getCheckversoin());
//				
//				Log.i("efun Switch", "checkversoin :" +bean);
//				
//				EfunSwitchHelper.saveCheckversoin(context, switchParameters.getCheckversoin());
//				
//				Log.i("efun Switch", "checkversoin" + EfunSwitchHelper.getCheckversoinBean(context) );
//				
//			}
//		});
//		
