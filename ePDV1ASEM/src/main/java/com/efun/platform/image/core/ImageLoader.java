...
import com.efun.platform.image.core.assist.FailReason;
import com.efun.platform.image.core.assist.FlushedInputStream;
import com.efun.platform.image.core.assist.ImageSize;
import com.efun.platform.image.core.assist.LoadedFrom;
import com.efun.platform.image.core.assist.ViewScaleType;
import com.efun.platform.image.core.imageaware.ImageAware;
import com.efun.platform.image.core.imageaware.ImageViewAware;
import com.efun.platform.image.core.imageaware.NonViewAware;
import com.efun.platform.image.core.listener.ImageLoadingListener;
import com.efun.platform.image.core.listener.ImageLoadingProgressListener;
import com.efun.platform.image.core.listener.SimpleImageLoadingListener;
import com.efun.platform.image.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.efun.platform.image.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.efun.platform.image.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.efun.platform.image.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.efun.platform.image.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.efun.platform.image.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
		...
		if (TextUtils.isEmpty(uri)) {
			engine.cancelDisplayTaskFor(imageAware);//取消加载与显示图片
			listener.onLoadingStarted(uri, imageAware.getWrappedView());//空操作？
	 ...
	 * {@link com.efun.platform.image.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.efun.platform.image.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.efun.platform.image.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.efun.platform.image.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
