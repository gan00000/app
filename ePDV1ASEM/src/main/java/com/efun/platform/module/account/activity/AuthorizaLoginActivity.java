...
import com.eee.request.AppRequest;
import com.eee.request.AppRequestManage;
...
//                AppRequestManage.appLogin(AuthorizaLoginActivity.this, name, passowrd, new AppRequest.RequestCallBack() {
//                });
            }
        });
...
//				confirmPwd = mConfirm.getText().toString();
    ...
    AppRequest.RequestCallBack loginCallBack = new AppRequest.RequestCallBack(){
        ...
        public void callback(String r) {
            ...
            try {
                if (TextUtils.isEmpty(r)){
                    ToastUtils.toast(mContext, "request time out");
                }

                JSONObject loginRes = new JSONObject(r);

                String code = loginRes.optString("code","");
                if (code.equals(HttpParam.RESULT_1000)){

                    String uid = loginRes.optString("userid","");
                    String sign = loginRes.optString("sign","");
                    String timestamp = loginRes.optString("timestamp","");

                }else{
                    ToastUtils.toast(mContext, loginRes.optString("message",""));
                }
...
//	}
    ...
    @Override
    public int LayoutId() {
        return E_layout.efun_pd_authoriza_login_new;
    }
