...
//		});
		...
		/*EfunTwitterShare.startTwitterShare(ctx, msg, "", "", new EfunShareCallback() {
		...
		EfunTwitterShare.startTwitterShare(((Activity) ctx), msg, "", "");
	}
...
//				});
//		
////		EfunTwitterShare.getIntsance().startTwitterShare(context, message, picUrl, url, efunShareEntity);
//	}
	...
	public static void shareEmail(Context context,String emailSubject,String emailBody){
		//发邮件  
	        ...
	        // email.putExtra(android.content.Intent.EXTRA_EMAIL, emailReciver);  
	         ...
	         //调用系统的邮件系统  
	         ((Activity) context).startActivity(Intent.createChooser(email, "请选择邮件分享"));  
	}
