...
//		String date = Store.getResponseByClazz(context, AccountResponse.class);
	 ...
	 * @return
	 */
	public static BaseRequestBean createRequest(Context context){
...
//		HashMap<String, String > paramsMap = Store.createValuesByClazz(context, keys, AccountLoginRequest.class);
		...
		if(paramsMap.get("loginType").equals(LoginPlatform.EFUN)){
			...
			AccountThirdLoginRequest loginRequest = new AccountThirdLoginRequest(context);
			loginRequest.setLoginType(paramsMap.get("loginType"));
			loginRequest.setPlatform(HttpParam.PLATFORM_AREA);
			loginRequest.setDevice(HttpParam.PHONE);
			loginRequest.setThirdId(paramsMap.get("thirdId"));
			loginRequest.setApps(paramsMap.get("apps"));
...
//	 * @return
//	 */
//	public static AccountThirdLoginRequest createThirdLoginRequest(Context context){
//		String[] keys = new String[]{"uid","username","password","loginType","thirdId","apps"};
////		HashMap<String, String > paramsMap = Store.createValuesByClazz(context, keys, AccountLoginRequest.class);
//		HashMap<String, String > paramsMap = StoreUtil.getValues(context, keys, StoreUtil.Request_file_name_login_request);
//		IPlatApplication.get().setPfLType(paramsMap.get("loginType"));
